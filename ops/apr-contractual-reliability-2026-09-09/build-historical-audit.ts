...
const currentBundle = path.join(repositoryRoot, "ops/apr-canonical-preflight-package-r101-2026-09-09/built-bundle-unrestricted");
const output = path.join(repositoryRoot, "ops/apr-canonical-preflight-package-r101-2026-09-09/historical-audit-report-r101.json");
