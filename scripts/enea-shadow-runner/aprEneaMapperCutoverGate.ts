...
export const APR_ENEA_MAPPER_CUTOVER_GATE_VERSION = "apr-enea-mapper-cutover-gate-v1" as const;

export interface AprEneaMapperCutoverGateEvidence {
...
export function evaluateEneaMapperCutoverGate(evidence: AprEneaMapperCutoverGateEvidence) {
  ...
  return Object.freeze({
    schemaVersion: APR_ENEA_MAPPER_CUTOVER_GATE_VERSION,
