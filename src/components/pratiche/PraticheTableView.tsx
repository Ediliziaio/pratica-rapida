...
import { ArrowRight, Building2, SearchX, Trash2, User } from "lucide-react";
  ...
  if (pratiche.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed py-16 text-center">
        ...
        <p className="font-semibold text-muted-foreground">Nessuna pratica corrisponde ai filtri</p>
        <p className="mt-1 text-xs text-muted-foreground">Rimuovi uno o più filtri per vedere i risultati</p>
      </div>
    );
  }
                  ...
                  <div className="flex items-center gap-1">
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive hover:text-destructive" aria-label="Elimina pratica">
                    ...
                    <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Apri pratica" onClick={() => navigate(`/pratiche/${p.id}`)}>
