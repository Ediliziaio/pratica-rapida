...
import { birthNationFromProvince, deterministicProtectedWindowSurface, isPortalManagedField, normalizeBuildingFingerprint, operationalRuleFor, residenceNationFromProvince, resolveBeneficiaryFiscalCode, resolveCoolingPerformance, resolveScreeningMechanism, shadowWindowTestAssumptions, verifiedShadowWindowGlassType } from "./operationalRules";
...
describe("workflow CRM ombra", () => {
  ...
  it("deriva inizio dal primo documento e fine dall'ultimo senza duplicarli", () => {
    expect(resolveWorkDates([
      { date: "2026-07-28", sourceDocumentId: "saldo", kind: "pertinent_document" },
      { date: "2026-06-30", sourceDocumentId: "acconto", kind: "pertinent_document" },
