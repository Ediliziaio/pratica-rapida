                ...
                {privatoDisponibile ? (
                  <>
                    ...
                    {prezzoPrivato && (
                      ...
                      <strong className="text-foreground">{euro(prezzoPrivato.imponibileCents)}</strong>
                      {` + IVA ${prezzoPrivato.ivaPercent}%`}.</>
                    )}
                  </>
                ) : (
          ...
          <div className="text-sm text-muted-foreground hidden sm:block">
            ...
            {isPrivato
              ? [PRODOTTI.find((p) => p.id === tipoProdotto)?.short,
                 prezzoPrivato ? `${euro(prezzoPrivato.imponibileCents)} + IVA ${prezzoPrivato.ivaPercent}%` : undefined,
                ].filter(Boolean).join(" · ")
