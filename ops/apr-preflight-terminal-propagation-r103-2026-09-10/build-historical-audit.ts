...
const currentBundle = path.join(repositoryRoot, "ops/apr-preflight-terminal-propagation-r103-2026-09-10/built-bundle");
const output = path.join(repositoryRoot, "ops/apr-preflight-terminal-propagation-r103-2026-09-10/historical-audit-report-r103.json");
