  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12 mx-auto" stroke="hsl(152 65% 38%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <rect x="34" y="18" width="10" height="8" rx="1" />
        <rect x="4" y="30" width="10" height="8" rx="1" />
        <rect x="19" y="30" width="10" height="8" rx="1" />
        <rect x="34" y="30" width="10" height="8" rx="1" />
      ...
      <main className="min-h-screen bg-white pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <a href="/auth" className="font-bold underline hover:text-orange-900 transition-colors">
