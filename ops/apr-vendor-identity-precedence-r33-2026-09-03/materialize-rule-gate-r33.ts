...
const snapshot = materializeAprRuleProofs({
  ...
  rootDirectory: "ops/apr-vendor-identity-precedence-r33-2026-09-03/rule-gate-r33",
  rawReportPath: "ops/apr-vendor-identity-precedence-r33-2026-09-03/full-vitest-r33.json",
