...
const currentBundle = path.join(repositoryRoot, "ops/apr-multi-invoice-parser-r102-2026-09-10/built-bundle-unrestricted");
const output = path.join(repositoryRoot, "ops/apr-multi-invoice-parser-r102-2026-09-10/historical-audit-report-r102.json");
