...
exec /usr/bin/caffeinate -i /usr/bin/env \
  APR_BATCH_RUN_ID=apr-wide148-post-portal-rejection-r127-20260915 \
  'APR_BATCH_REPORT_TITLE=APR r127 — rilancio notturno delle stesse 148 pratiche' \
