...
const PERM_MATRIX: PermRow[] = [
  ...
  { label: "Wallet / Estratto Conto", category: "FINANZE",        perms: { super_admin: false, admin_interno: false, operatore: false, azienda_admin: true,  azienda_user: true,  rivenditore: false } },
