...
const rootDirectory = path.join(repositoryRoot, "ops/apr-reliability-gap-audit-2026-09-03/rule-gate-r46");
const rawReportPath = path.join(repositoryRoot, "ops/apr-reliability-gap-audit-2026-09-03/full-vitest-r46-final.json");
