...
const faqs: { cat: string; q: string; a: string }[] = [
  ...
  { cat: "generale", q: "Il mio cliente saprà che usate un servizio esterno?", a: "Chiamiamo noi il cliente a tuo nome, presentandoci come il tuo ufficio tecnico. La relazione commerciale rimane sempre tua." },
  ...
  { cat: "enea", q: "Cosa succede se c'è un errore nella pratica?", a: "La responsabilità è nostra. In caso di errore imputabile a noi, lo correggiamo immediatamente e gratuitamente. La responsabilità è nostra, non tua." },
  ...
  { cat: "ct", q: "Cosa succede se la pratica viene respinta dal GSE?", a: "Con il nostro servizio non accade: la documentazione viene preparata secondo ogni requisito tecnico del GSE e verificata prima dell'invio. In ogni caso, la responsabilità è nostra e, se ci fosse un nostro errore, lo correggiamo gratuitamente." },
