...
const snapshot = materializeAprRuleProofs({
  ...
  rootDirectory: "ops/apr-reliability-gap-audit-2026-09-03/rule-gate-r35",
  rawReportPath: "ops/apr-reliability-gap-audit-2026-09-03/full-vitest-r35-final.json",
  testCommand: "vitest run --shard=1/8..8/8 --pool=forks --reporter=json",
});
