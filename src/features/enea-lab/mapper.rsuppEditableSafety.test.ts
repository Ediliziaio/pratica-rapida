...
describe("mapper ENEA · Rsupp verificabile", () => {
  it("mantiene Rsupp opzionale ma modificabile per una schermatura solare senza dedurla automaticamente", () => {
  ...
  it("rende Rsupp obbligatoria e modificabile per una chiusura oscurante senza dedurla automaticamente", () => {
    const source = ENEA_LAB_MOCK_PRACTICES[0];
