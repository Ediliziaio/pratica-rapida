...
const installReceiptPath = path.resolve(import.meta.dirname, "../apr-install-full-reconstruction-verified-r86-2026-09-08/install-receipt.json");
...
const VALIDATION_REVISION = "apr-full-reconstruction-r86-2026-09-08";
const now = new Date();
...
const summary = {
  version: "apr-full-reconstruction-r86-summary-v1",
