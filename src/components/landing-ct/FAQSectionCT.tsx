...
const faqs = [
  { q: "Quanto costa il servizio per il Conto Termico?", a: "Nessun canone mensile, nessun costo di attivazione, nessun vincolo contrattuale. Contattaci per il listino aggiornato." },
  ...
  { q: "Cosa succede se la pratica viene respinta dal GSE?", a: "Con il nostro servizio non accade: la documentazione viene preparata secondo ogni requisito tecnico del GSE. In ogni caso, la responsabilità è nostra e, se ci fosse un errore, lo correggiamo immediatamente e gratuitamente." },
