      ...
      {NEWS_ITEMS.map((item, i) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs sm:text-sm text-white leading-snug truncate">{item.title}</p>
            <p className="text-[11px] mt-0.5" style={{ color: "rgba(255,255,255,0.38)" }}>{item.date}</p>
          </div>
          {item.badge && (
            <span
