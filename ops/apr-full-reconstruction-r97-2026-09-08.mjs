...
const installReceiptPath = path.resolve(import.meta.dirname, "apr-install-reseller-addressee-batch-r97-2026-09-08-2026-09-08/install-receipt.json");
...
const VALIDATION_REVISION = "apr-full-reconstruction-r97-2026-09-08";
...
writeFileSync(path.join(import.meta.dirname, "apr-full-reconstruction-r97-2026-09-08-wide100-results.json"), JSON.stringify(wide100Results, null, 2));
writeFileSync(path.join(import.meta.dirname, "apr-full-reconstruction-r97-2026-09-08-overnight-results.json"), JSON.stringify(overnightResults, null, 2));
