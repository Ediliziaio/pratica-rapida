...
run_root='/Users/giulianolavoro/Library/Application Support/PraticaRapida/enea-shadow-runner/runs/apr-workable76-certificate-measures-total-r123-20260913'
runner_path="$repository_root/scripts/enea-shadow-runner/simple-independent-runner.mjs"
bundle_path='/Users/giulianolavoro/Library/Application Support/PraticaRapida/enea-shadow-runner/canonical-bundle/versions/9720ac8c-certificate-measures-columnar-total-r123-20260913'
...
exec /usr/bin/caffeinate -i \
  /usr/bin/env \
  APR_BATCH_RUN_ID=apr-workable76-certificate-measures-total-r123-20260913 \
  'APR_BATCH_REPORT_TITLE=APR — giro completo 76 con misure da certificati e totale stampato a colonne r123' \
  ...
  APR_BATCH_WORKER_SHA256=284decdfae9737008d657f360132abc6062e5f5ef94d1d3031069f067d44e79e \
  APR_BATCH_COHORT_OFFSET=8100 \
