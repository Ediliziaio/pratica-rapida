...
const root = path.join(repositoryRoot, "ops/apr-install-patch-cf-sequencer-20260916-2026-09-16");
const baselineBundle = "/Users/giulianolavoro/Library/Application Support/PraticaRapida/enea-shadow-runner/canonical-bundle/versions/53d58e3c-post-wide148-portal-rejection-r127-20260915";
const currentBundle = path.join(root, "staged-bundle");
const output = path.join(root, "historical-audit-report.json");
