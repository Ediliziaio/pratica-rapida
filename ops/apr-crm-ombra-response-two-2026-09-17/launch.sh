...
MANIFEST="$SOURCE_ROOT/ops/apr-crm-ombra-response-two-2026-09-17/manifest.json"
RUN_ID="apr-crm-ombra-response-two-20260917"
RUN_ROOT="$RUNTIME_ROOT/runs/$RUN_ID"
AUTHORIZATION_ID="user-2026-09-17-crm-ombra-response-two-draft-only-v1"
...
prepare_case 10571 "5bd45fbe-1700-4d13-b545-ecd9a48b7e27" "daniele-miracapillo" "DANIELE MIRACAPILLO" "infissi"
prepare_case 10572 "34572044-6e01-465a-ab01-f937d3ec4b87" "marco-zambella" "Marco Zambella" "screening"

export APR_BATCH_RUN_ID="$RUN_ID"
export APR_BATCH_REPORT_TITLE="APR CRM ombra - risposte Miracapillo e Zambella"
...
export APR_BATCH_COHORT_OFFSET="10570"
export APR_BATCH_EXPECTED_COUNT="2"
