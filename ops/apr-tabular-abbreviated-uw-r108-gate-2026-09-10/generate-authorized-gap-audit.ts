...
const gateRoot = path.join(repositoryRoot, "ops/apr-tabular-abbreviated-uw-r108-gate-2026-09-10");
...
const output = path.join(gateRoot, "historical-audit-report-r108.json");
