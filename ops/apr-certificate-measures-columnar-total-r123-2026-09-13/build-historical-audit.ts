...
const root = path.join(repositoryRoot, "ops/apr-certificate-measures-columnar-total-r123-2026-09-13");
...
const output = path.join(root, "historical-audit-report-r123.json");
