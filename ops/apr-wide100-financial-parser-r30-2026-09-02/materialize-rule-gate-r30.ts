...
const snapshot = materializeAprRuleProofs({
  ...
  rootDirectory: "ops/apr-wide100-financial-parser-r30-2026-09-02/rule-gate-r30",
  rawReportPath: "ops/apr-wide100-financial-parser-r30-2026-09-02/full-vitest-r30.json",
