...
run_root='/Users/giulianolavoro/Library/Application Support/PraticaRapida/enea-shadow-runner/runs/apr-mauro-ballabio-r126-replay-20260915'
...
exec /usr/bin/caffeinate -i /usr/bin/env \
  APR_BATCH_RUN_ID=apr-mauro-ballabio-r126-replay-20260915 \
  'APR_BATCH_REPORT_TITLE=APR r126 — replay singolo Mauro Ballabio' \
  "APR_BATCH_RUN_ROOT=$run_root" \
  APR_BATCH_MANIFEST="$repository_root/ops/apr-mauro-ballabio-r126-replay-2026-09-15/manifest.json" \
  "APR_BATCH_BUNDLE=$bundle_path" \
  APR_BATCH_MANIFEST_SHA256=f392ed53405b4bd24397e866c93016d1d4478f8cc42d30d45d790ee014e80cd4 \
  APR_BATCH_WORKER_SHA256=3e06c95078ad5c7822899d8ce494292d8d2b24374a60fa2940990618275f2ef8 \
  APR_BATCH_COHORT_OFFSET=10148 \
  APR_BATCH_EXPECTED_COUNT=1 \
