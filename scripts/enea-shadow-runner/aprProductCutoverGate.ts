...
export const APR_PRODUCT_CUTOVER_GATE_VERSION = "apr-product-cutover-gate-v1" as const;

export interface AprProductCutoverGateEvidence {
...
export function evaluateProductCutoverGate(evidence: AprProductCutoverGateEvidence) {
  const failedChecks = [
  ...
  return Object.freeze({
    schemaVersion: APR_PRODUCT_CUTOVER_GATE_VERSION,
