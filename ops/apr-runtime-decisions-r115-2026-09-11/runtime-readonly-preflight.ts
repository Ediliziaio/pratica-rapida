...
const outputRoot = path.join(repositoryRoot, "ops/apr-runtime-decisions-r115-2026-09-11/runtime-readonly-preflight");
...
const expectedWorkerSha256 = "6a0d11677a9d8fc056b7b375cae76a4d417d1f52325cb98ec99620fea33b0ccc";
const requiredRuleIds = [
  "user-2026-09-10-infissi-invoice-authoritative-shading-closures-v1",
  "user-2026-09-10-infissi-explicit-no-screen-negative-closure-evidence-v1",
  "user-2026-09-11-infissi-closure-measurements-not-applicable-v1",
  "user-2026-09-11-zanzariera-first-window-allocation-v1",
  "user-2026-09-11-invoice-final-printed-total-runtime-authority-v1",
  "user-2026-09-11-crm-practice-id-lookup-stage-independent-v1",
];
...
const ownerId = `apr-r115-runtime-readonly-preflight-${process.pid}`;
...
try {
  ...
  const result = {
    version: "apr-r115-runtime-readonly-preflight-v1",
    checkedAt: new Date().toISOString(),
    status: session.authenticated && !session.serverLogoutProven ? "PASS" : "LOGIN_REQUIRED",
    runtimeBundle: {
      canonicalDirectory: realpathSync(bundleRoot), workerPath: realpathSync(workerPath), workerSha256,
      expectedWorkerSha256, governanceStatus: governance.status, governanceAttestationPath: governance.attestationPath,
      governanceAttestationSha256: governance.attestationSha256, requiredRuleIds, missingRuleIds,
    },
  ...
  try { controller.release(access); } catch { /* fenced: no reuse */ }
}
