...
exec /usr/bin/caffeinate -i \
  /usr/bin/env \
  APR_BATCH_RUN_ID=apr-workable76-bundle-governed-r120-20260913 \
  'APR_BATCH_REPORT_TITLE=APR — giro completo 76 con checkpoint governato dal bundle r120' \
