...
const root = path.join(repositoryRoot, "ops/apr-install-operator-latest-response-closures-r126-2026-09-14");
const baselineBundle = "/Users/giulianolavoro/Library/Application Support/PraticaRapida/enea-shadow-runner/canonical-bundle/versions/8b2652b6-operator-responses-payload-form-r125-20260914";
const currentBundle = path.join(root, "staged-bundle");
const output = path.join(root, "historical-audit-report-r126.json");
