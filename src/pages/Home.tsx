      ...
      <Section id="confronto" className="bg-[#0d1a2d]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl p-8 border card-hover-glow" style={{ backgroundColor: `${PR_GREEN}08`, borderColor: `${PR_GREEN}30` }}>
              <h3 className="text-lg font-bold mb-6 flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5" style={{ color: PR_GREEN }} /> Pratica Rapida
              </h3>
              <ul className="space-y-3">
                {[
