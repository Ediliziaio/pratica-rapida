...
const faqs: { cat: string; q: string; a: string }[] = [
  ...
  { cat: "generale", q: "Chi può usare il servizio?", a: "Il servizio è rivolto a installatori, rivenditori e aziende che effettuano lavori di efficienza energetica: serramenti, tende da sole, schermature solari, fotovoltaico, caldaie, pompe di calore, solare termico e altri interventi agevolati." },
  ...
  { cat: "enea", q: "Per quali interventi è necessaria la pratica ENEA?", a: "Serramenti e infissi, tende da sole e schermature solari, caldaie a condensazione, pompe di calore per riscaldamento, fotovoltaico con accumulo, vetrate panoramiche, isolamento termico dell'involucro e tutti gli interventi previsti dall'Ecobonus." },
  ...
  { cat: "prezzi", q: "Come avviene il pagamento?", a: "Tramite carta di credito o bonifico bancario attraverso il portale Pratica Rapida. Ricevi una ricevuta fiscale per ogni pratica completata." },
  { cat: "prezzi", q: "Posso ricevere fattura?", a: "Sì. Emettiamo regolare fattura elettronica per ogni pratica completata o su base mensile a riepilogo, a seconda delle tue preferenze di fatturazione." },
