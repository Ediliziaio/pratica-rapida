...
const runId = process.env.APR_BATCH_RUN_ID || "apr-wide100-final-r67-20260906";
const reportTitle = process.env.APR_BATCH_REPORT_TITLE || "APR — collaudo finale delle 100 pratiche, r67";
const runRoot = process.env.APR_BATCH_RUN_ROOT || path.join(runtimeRoot, "runs", runId);
const sourceManifestPath = process.env.APR_BATCH_MANIFEST || path.join(sourceRoot, "ops/apr-wide100-province-lineage-2026-09-02/manifest.json");
const sequencerPath = path.join(sourceRoot, "ops/apr-global-controller-test10-2026-08-29/sequencer.mjs");
const bundlePath = process.env.APR_BATCH_BUNDLE || path.join(runtimeRoot, "canonical-bundle/versions/b52ec569-terminal-cohort-quiescence-r67-20260906");
const expectedManifestSha256 = process.env.APR_BATCH_MANIFEST_SHA256 || "51842252f71cabb6714f78923fe59ec9789ad06739393f61a553bb4bdb9154e0";
const expectedWorkerSha256 = process.env.APR_BATCH_WORKER_SHA256 || "b52ec569d32ccc340f315697f294e2e43622dfd9029cc3f8d36f880b9dd6239e";
const cohortOffset = Number(process.env.APR_BATCH_COHORT_OFFSET || "3170");
...
function makeSingleManifest(item) {
  return {
    version: "apr-wide100-final-r67-single-case-v1",
