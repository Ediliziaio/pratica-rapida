...
describe("mapper ENEA · Rsupp verificabile", () => {
  it("non propone Rsupp come modificabile per una schermatura solare", () => {
  ...
  it("rende Rsupp modificabile soltanto per una chiusura oscurante senza dedurla automaticamente", () => {
    const source = ENEA_LAB_MOCK_PRACTICES[0];
